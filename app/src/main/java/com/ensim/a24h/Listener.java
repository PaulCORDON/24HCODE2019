...
public class Listener implements MqttCallback {
    ...
    /** The broker url. */
    private static final String brokerUrl = "tcp://mpd.lan:1883";

    /** The client id. */
    private static final String clientId = "Flo";

    /** The topic. */
    private static final String topic = "distance/value";
